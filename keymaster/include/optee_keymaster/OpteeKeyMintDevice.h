...
class OpteeKeyMintDevice : public BnKeyMintDevice {
  public:
    explicit OpteeKeyMintDevice(shared_ptr<OpteeKeymaster> impl) : impl_(std::move(impl)) {}
    virtual ~OpteeKeyMintDevice() = default;
