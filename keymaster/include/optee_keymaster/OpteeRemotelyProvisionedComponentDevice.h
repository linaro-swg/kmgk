...
class OpteeRemotelyProvisionedComponentDevice : public BnRemotelyProvisionedComponent {
  public:
    explicit OpteeRemotelyProvisionedComponentDevice(shared_ptr<OpteeKeymaster> impl)
        : impl_(std::move(impl)) {}
    virtual ~OpteeRemotelyProvisionedComponentDevice() = default;
